      ...
      <div className='flex flex-wrap'>
        <div className='w-full lg:w-1/2'>
          <div className='flex flex-col items-center lg:items-start'>
            <h1 className='pb-16 text-10xl font-thiner tracking-tight lg-mt-16 lg-text-8xl ml-15 mt-20 bg-gradient-to-r from-pink-300 via-slate-500 to-purple-500 bg-clip-text text-4xl tracking-tight text-transparent ml-15'>
              Jagruthi Pulumati
            </h1>
            ...
            <p className='my-2 max-w-10xl py-6 font-light tracking-tighter ml-15 text-xl'>{HERO_CONTENT}</p>
          </div>
        </div>
